      ...
      <div class="login-content">
        ...
        <div class="login-form">
          <div class="text-center">
            <img class="align-content" src="../img/logo.png" width="70%" alt="Neuromex" />
          </div>
          <hr>
          <form id="login-frm">
      ...
      jQuery.ajax({
        ...
        success: function(response) {
          ...
          if (r.success) {
            ...
            setTimeout(function() {
              location.href = 'mng-inicio/';
            }, 2500);
          } else alerta('Error!', r.msg, 'error', 'Aceptar');
        },
        error: function() {
          alerta('Error!', 'No se pudo conectar al servidor, inténtelo más tarde', 'error', 'Aceptar');
        }
      });
    });
