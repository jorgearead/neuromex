<?php
  session_start();
  $URLBASE = 'http://localhost/neuro/admin-neuromex/';
  $icono = 'http://localhost/neuro/img/favicon.png';
  $logo = 'http://localhost/neuro/img/logo.png';
  if(empty($_SESSION['user'])) echo '<script>location.href="http://localhost/neuro/";</script>';
